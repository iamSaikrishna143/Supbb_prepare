...
// The Virtual DOM (Document Object Model) is a lightweight, in-memory representation
//  of the real DOM elements generated by React components. Instead of directly manipulating 
// the browser’s DOM every time something changes, React creates a Virtual DOM tree that mirrors
//  the structure of the UI. When a component’s state or props change, React updates the Virtual
//  DOM first.

// React then compares the new Virtual DOM with the previous version using a process called
//  “diffing.” This allows React to efficiently determine exactly what has changed. After
//  identifying the differences, React batches and applies only the necessary updates to the
//  real DOM, rather than re-rendering the entire UI. This approach minimizes expensive DOM 
// operations and results in faster, more efficient rendering, especially in complex applications.
//  The Virtual DOM is a key reason why React apps feel fast and responsive.
